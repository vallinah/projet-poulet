...
<%@page import="util.fournisseur.ProduitLivrer"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%
    List<ProduitLivrer> all = (List<ProduitLivrer>) request.getAttribute("listelivrer");
%>
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main" class="container mt-5">
    <section id="product-table" class="mt-5">
      <div class="container" data-aos="fade-up">
        <h2>Table des Produits livre</h2>
        <table class="table table-striped table-bordered">
          ...
          <tbody>
            <% 
                if (all != null) {
                    for (ProduitLivrer proformat : all) {
            %>
            <tr>
                <td><%= proformat.getDateMouvement() %></td>
                <td><%= proformat.getProduit().getNom() %></td> <!-- Assurez-vous que getNomProduit() existe -->
