  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Votre partenaire de<br><span>confiance pour</span><br>un élevage de qualité.</h2>
        <div>
          <a href="connexion.jsp" class="btn-get-started scrollto">Connexion</a>
          <a href="inscription.jsp" class="btn-services scrollto">Inscription</a>
        </div>
      </div>
