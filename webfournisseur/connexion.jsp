      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="map mb-4 mb-lg-0">
                <img src="assets/img/fournisseur.jpg" alt="" class="img-fluid">
          </div>
        </div>

        <div class="col-lg-6">
          <div class="form">
            <form action="connexion" method="get" class="php-email-form">
              <div class="row">
              ...
              <div class="form-group mt-3">
                <input type="password" class="form-control" name="mdp" id="mdp" placeholder="Mots de passe" required>
              </div>
              <div class="my-3">
